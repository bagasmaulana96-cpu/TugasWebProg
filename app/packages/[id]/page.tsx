    ...
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="bg-white rounded-2xl shadow-md p-8">
        ...
        <div className="mt-8 flex items-center justify-between flex-wrap gap-4">
          ...
          {/* Tombol WhatsApp */}
          href={whatsappUrl}
          target="_blank" rel="noopener noreferrer" className="bg-navy
          text-white font-bold px-8 py-4 rounded-full hover:bg-soft-blue
          hover:text-navy transition text-lg"
